...
```
--- Depending on the environment (macOS) 
```
$ brew install mysql httpd php@8.4
...
--- Depending on the environment (macOS)
```
$ sudo chown $(whoami):_www /usr/local/var/www/calender017/ (macOSの場合)
